!Important!
This Mod isn't currently working directly with Optifine (1.14.4) because Optifine also patches the Renderer Class and changing the Priority causes a Crash. You can remove the following Files from the Optifine Jar to make it work, however i don't know how this effects on the functionallity of Optifine.
